                    ...
                    <form class="form-horizontal" style="margin-top: 20px;">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="data1_1" class="col-sm-3 control-label">Nama Pemohon</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="data1_1" name="data1_1" placeholder=". . ." value="Audie Ali Akhmad" readonly />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="data1_2" class="col-sm-3 control-label">Jenis Pengajuan</label>
                                <div class="col-sm-4">
                                    <select class="form-control select2" id="data1_2" name="data1_2" style="width: 100%;" disabled>
                                        <option value=""></option>
                            ...
                            <div class="form-group">
                                <label for="data1_3" class="col-sm-3 control-label">Nomor Paspor Lama</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="data1_3" name="data1_3" placeholder=". . ." />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="data1_4" class="col-sm-3 control-label">Jenis Paspor</label>
                                <div class="col-sm-4">
                                    <select class="form-control select2" id="data1_4" name="data1_4" style="width: 100%;" disabled>
                                        <option value=""></option>
                            ...
                            <div class="form-group">
                                <label for="data1_5" class="col-sm-3 control-label">Tempat Pengeluaran Paspor</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="data1_5" name="data1_5" placeholder=". . ." />
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="data1_6" class="col-sm-3 control-label">Kantor Imigrasi</label>
                                <div class="col-sm-4">
                    ...
                    <form class="form-horizontal" style="margin-top: 20px;">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="data4_4" name="data4_4" placeholder="Tahun Lulus ..." />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="data4_6" name="data4_6" placeholder="Tahun Lulus ..." />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input type="text" class="form-control" id="data4_8" name="data4_8" placeholder="Tahun Lulus ..." />
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
